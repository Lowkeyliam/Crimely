...
class ComplaintViewModel(var navController:NavHostController, var context: Context) {
    ...
    fun uploadComplaint(complainant:String, complaintdes:String, phoneno:String, filePath:Uri){
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var complaint = Complaint(complainant,complaintdes,phoneno,imageUrl,complaintId)
